...
scp $SLURM_SUBMIT_DIR/data/test/Test/Test/GroundTruth/test_HIPS_HYBRIDS_2023_V2.3.csv data/test/Test/Test/GroundTruth/test_HIPS_HYBRIDS_2023_V2.3.csv
scp $SLURM_SUBMIT_DIR/src/blup.R src/
...
cp $SLURM_SUBMIT_DIR/logs/model_$SLURM_JOB_ID.out $SLURM_SUBMIT_DIR/output/results.txt
